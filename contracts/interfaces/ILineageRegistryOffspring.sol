 ...
 * ## When to install it
 *
 * The index is derived data — an off-chain indexer can rebuild it from complete-pair
 * ParentageLinked updates and ERC-721 burn events. It adds one array push per known
...
interface ILineageRegistryOffspring {
    ...
    ///         exist. Ordering is unspecified; removals may reorder entries.
    ...
    /// @notice How many live offspring `tokenId` has. Reverts for absent tokens. Constant cost.
